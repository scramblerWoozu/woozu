...
class SettingButton extends StatelessWidget {
  const SettingButton({
    ...
    required this.size,
        ...
        _introductionController = introductionController,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        UserRepository().updateUser(context, user.uid, _interestController.text,
            _countryController.text, _introductionController.text);
      },
      child: Container(
        width: size.width,
        height: 40,
